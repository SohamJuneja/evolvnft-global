# 🔐 Contract Verification Guide for EvolvNFT

## 📊 **Contract Information**
- **Contract Address**: `0xED32eAE05bdcB1fDabB02b0E0fb4148eFDa486c9`
- **Network**: Somnia Testnet  
- **Explorer**: https://shannon-explorer.somnia.network/address/0xED32eAE05bdcB1fDabB02b0E0fb4148eFDa486c9

## 🛠️ **Verification Details**

### **Basic Information**
- **Contract Name**: `EvolvNFT`
- **Compiler Version**: `v0.8.20+commit.a1b79de6`
- **Optimization**: Enabled with 200 runs
- **License**: MIT

### **Constructor Arguments**
The contract uses a simple constructor with no parameters:
```solidity
constructor()
    ERC721("EvolvNFT", "EVO")
    Ownable(msg.sender)
...
**Encoded Constructor Arguments**: `(empty - no parameters required)`

## 📋 **Step-by-Step Verification Process**

### **Method 1: Hardhat Verification (Automated)**
```bash
# Set your environment variables
export PRIVATE_KEY="your_private_key"
export SOMNIA_RPC_URL="https://rpc.ankr.com/somnia_testnet/6d98f304a89a1bae8c99518de1733780853d152e34f4f110555e94c4514d47c8"

# Run verification
npx hardhat verify --network somniaTestnet 0xED32eAE05bdcB1fDabB02b0E0fb4148eFDa486c9
```
...
2. **Click "Verify & Publish"** (usually in the Code tab)
...
#### **📄 Source Code** (Copy the entire contract):
```solidity
...
- 📄 **Source code** tab with full contract code
- 🔧 **Read Contract** functions available
- ✍️ **Write Contract** functions available
- 📊 **Full transaction history** with decoded function calls

## 🏆 **Benefits of Verification**

1. **🔍 Transparency**: Anyone can read your contract code
2. **🛡️ Trust**: Users can verify the contract does what it claims  
3. **🔧 Interaction**: Better UI for calling contract functions
4. **📊 Analytics**: Explorer shows decoded events and function calls
5. **🏅 Credibility**: Verified contracts look more professional

## 📞 **Need Help?**

If verification fails, check:
- ✅ Compiler version matches exactly (v0.8.20)  
- ✅ Optimization settings are correct (enabled, 200 runs)
- ✅ Source code is exactly as deployed
- ✅ No extra spaces or characters in the code

The contract is ready for verification! 🎉
